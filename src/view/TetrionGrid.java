 ...
 */
public class TetrionGrid extends JPanel implements PropertyChangeListener {
	...
	/** TetrionGrid background layered pane */
	private static JLayeredPane myLayeredPane;

	
	/**
	 * TetrionGrid default view layer constructor class
	 */
	public TetrionGrid() {
		super();
	...
	/**
	 * Set TetrionGrid component ui graphic effects on score level update
	 */
	@Override
	...
	/**
	 * Dynamically set the TetrionGrid background image
